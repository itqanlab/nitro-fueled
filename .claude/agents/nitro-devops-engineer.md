...
- "Set up GitHub Actions for builds" -> nitro-devops-engineer
- "Configure automated releases" -> nitro-devops-engineer
- "Optimize CI build times with caching" -> nitro-devops-engineer
- "Set up deployment pipeline" -> nitro-devops-engineer
- "Add Docker containerization" -> nitro-devops-engineer
- "Configure code signing" -> nitro-devops-engineer
...
if tasks.md exists:
  ...
  # Look for batch marked "IN PROGRESS - Assigned to nitro-devops-engineer"
...
8. **Return report** for nitro-team-leader verification
