...
| TASK_2026_279 | Rename Unprefixed .claude/ Dirs and Files to nitro-* (Structural Rename, Part 1) | COMPLETE | P2-Medium |
...
| TASK_2026_180 | Migrate @Input/@Output Decorators to Signal-Based input()/output() | COMPLETE | P2-Medium |
