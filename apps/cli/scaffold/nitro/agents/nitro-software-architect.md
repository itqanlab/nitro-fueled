...
**Before starting architecture work**, check if the nitro-ui-ux-designer has already created visual specifications:
...
- Recommend nitro-ui-ux-designer invocation for complex UI work
...
- `tasks.md` - Atomic task breakdown and completion status (managed by nitro-team-leader)
...
**NOTE**: You define WHAT to build and WHY. The nitro-team-leader will decompose this into HOW (atomic tasks).
...
**Recommended Developer**: [nitro-frontend-developer | nitro-backend-developer | both]
...
- [ ] Complexity assessed
- [ ] No step-by-step implementation (that's nitro-team-leader's job)
```
