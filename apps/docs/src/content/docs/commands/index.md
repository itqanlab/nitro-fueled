...
Nitro-Fueled provides two command surfaces: **CLI commands** (`npx @itqanlab/nitro-fueled`) for project setup and task execution, and **slash commands** (`/orchestrate`, `/plan`, `/auto-pilot`, etc.) for interactive use from inside Claude Code.
...
### `npx @itqanlab/nitro-fueled create`
...
### `npx @itqanlab/nitro-fueled run [TASK_ID]`
...
### `npx @itqanlab/nitro-fueled update`
...
Equivalent to `npx @itqanlab/nitro-fueled run` but from inside Claude Code. Automatically detects whether to start the full loop or run a single task.
...
|---------|---------|-------------|
| `npx @itqanlab/nitro-fueled init` | CLI | Initial project setup |
| `npx @itqanlab/nitro-fueled create` | CLI | New task creation |
| `npx @itqanlab/nitro-fueled run [TASK_ID]` | CLI | Execute task(s) |
| `npx @itqanlab/nitro-fueled status` | CLI | Check project health |
| `npx @itqanlab/nitro-fueled update` | CLI | Update core agents/skills/commands |
